                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($records as $key => $corp)
                                            ...
                                            @endif
                                        @endforeach
                                        <tr><td class="bg-success text-white">Municipalities</td><td colspan="{{ $scheme->question_count }}" class=""></td></tr>
                                        ...
                                        @foreach($records as $key => $mun)
                                            ...
                                            @endif
                                        @endforeach
                                        <tr><td class="bg-success text-white">Grama Panchayats</td><td colspan="{{ $scheme->question_count }}" class=""></td></tr>
