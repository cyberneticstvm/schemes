        ...
        <div class="row mb-3">
            <div class="col">
                <ol class="breadcrumb bg-transparent mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">C@S => Add</li>
                </ol>
            </div>
            <div class="col-auto">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-header py-3 bg-transparent border-bottom-0">
                        <h5 class="m-0 text-primary">Add Collectors @ School</h5>
                    </div>
                    <form method="post" action="{{ route('cschool.save') }}">
                        @csrf
                        <div class="card-body">
                            <div class="row mb-3">
                                <div class="col-md-2">
