            ...
            <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-header py-3 bg-transparent border-bottom-0">
                        <h5 class="m-0">Material Collection Facility</h5>
                    </div>
                    <form>
                        <div class="card-body">
                            <div class="row mb-3">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($corporations as $key => $corp)
                                                <tr>
                                                    <td>{{ $corp->name }}</td>
                                                    @foreach($questions as $key => $question)
                                                    <td><input type="{{ $question->type }}" min="0" class="form-control form-control-sm rounded-0 {{ $question->position }}" placeholder="{{ $question->placeholder }}" /></td>
                                                    @endforeach
                                                </tr>
                                            @endforeach
                            ...
                            <div class="row mt-3">
                                <div class="col-lg-12 text-center"><button type="submit" class="btn rounded-0 btn-primary me-2">SAVE</button><button type="button" class="btn rounded-0 btn-warning me-2">RESET</button><button type="button" class="btn rounded-0 btn-danger">CANCEL</button></div>
                            </div>
                        </div>
                    </form>
                </div> <!-- .card end -->
